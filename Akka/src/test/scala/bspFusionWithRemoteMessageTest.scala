...
abstract class EpidemicsFusionWithRemoteMessageTest extends scaleUpTest {
...
class gameOfLifeFusionWithRemoteMessageTest extends scaleUpTest {
...
class stockMarketFusionWithRemoteMessageTest extends scaleUpTest {
    def gen(scaleUpFactor: Int): IndexedSeq[Actor] = {
        val markets: Int = 1
...
class ERMFusionWithRemoteMessageTest extends EpidemicsFusionWithRemoteMessageTest {
    val p = 0.01
...
class SBMFusionWithRemoteMessageTest extends EpidemicsFusionWithRemoteMessageTest {
    val p =0.01
    val q = 0
    val numBlocks = 5
