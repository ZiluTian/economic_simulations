...
trait Item30Trait extends meta.deep.runtime.Actor with meta.example.supermarket.goods.Item with meta.example.supermarket.goods.Cream with meta.example.supermarket.goods.newItem {
    var age: Int = 0
...
class Item30 extends Item30Trait