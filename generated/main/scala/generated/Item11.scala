...
trait Item11Trait extends meta.deep.runtime.Actor with meta.example.supermarket.goods.Item with meta.example.supermarket.goods.Squash with meta.example.supermarket.goods.newItem {
    var age: Int = 0
...
class Item11 extends Item11Trait