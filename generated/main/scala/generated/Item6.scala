...
trait Item6Trait extends meta.deep.runtime.Actor with meta.example.supermarket.goods.Item with meta.example.supermarket.goods.Carrots with meta.example.supermarket.goods.newItem {
    var age: Int = 0
...
class Item6 extends Item6Trait