...
trait Item31Trait extends meta.deep.runtime.Actor with meta.example.supermarket.goods.Item with meta.example.supermarket.goods.Egg with meta.example.supermarket.goods.newItem {
    var age: Int = 0
...
class Item31 extends Item31Trait