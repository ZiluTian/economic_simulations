...
trait Item4Trait extends meta.deep.runtime.Actor with meta.example.supermarket.goods.Item with meta.example.supermarket.goods.Broccoli with meta.example.supermarket.goods.newItem {
    var age: Int = 0
...
class Item4 extends Item4Trait