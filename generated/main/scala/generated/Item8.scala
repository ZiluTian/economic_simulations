...
trait Item8Trait extends meta.deep.runtime.Actor with meta.example.supermarket.goods.Item with meta.example.supermarket.goods.Tomato with meta.example.supermarket.goods.newItem {
    var age: Int = 0
...
class Item8 extends Item8Trait