...
trait Item5Trait extends meta.deep.runtime.Actor with meta.example.supermarket.goods.Item with meta.example.supermarket.goods.Cucumber with meta.example.supermarket.goods.newItem {
    var age: Int = 0
...
class Item5 extends Item5Trait